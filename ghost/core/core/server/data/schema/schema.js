...
module.exports = {
    ...
    // The append-only store of every gift link; a link's liveness is tracked in post_gift_links.
    gift_links: {
        token: {type: 'string', maxlength: 64, nullable: false, primary: true},
    ...
    post_gift_links: {
        post_id: {type: 'string', maxlength: 24, nullable: false, references: 'posts.id', cascadeDelete: true, primary: true},
        gift_link_token: {type: 'string', maxlength: 64, nullable: false, references: 'gift_links.token', cascadeDelete: true, unique: true},
        created_at: {type: 'dateTime', nullable: false},
        updated_at: {type: 'dateTime', nullable: true}
    },
